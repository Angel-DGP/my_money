...
export class PrismaBudgetRepository implements IBudgetRepository {
  ...
  async save(budget: Budget): Promise<void> {
    await this.prisma.budget.upsert({
      ...
      update: {
        ...
        soft_limit: budget.softLimit?.value.toNumber(),
        hard_limit: budget.hardLimit?.value.toNumber(),
  ...
  private toDomain(data: any): Budget {
    return Budget.reconstitute({
      ...
      softLimit: data.soft_limit ? Money.of(data.soft_limit.toString(), data.currency) : undefined,
      hardLimit: data.hard_limit ? Money.of(data.hard_limit.toString(), data.currency) : undefined,
